...
public class JejuController5 {
	...
	/*
	 * @GetMapping("board_list_go.do") public ModelAndView boardListGo() { return
	 * new ModelAndView("ygh-view/board_list"); }
	 * 
	 * @GetMapping("report_list_go.do") public ModelAndView reportListGo() { return
	 * new ModelAndView("ygh-view/report_list"); }
	 */
