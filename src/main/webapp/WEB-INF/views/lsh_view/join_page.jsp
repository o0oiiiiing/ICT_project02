						...
						<ul>
							<li>
								...
								<div class="terms_box">
									<p>제1조(목적)</p>
										...
										<p>1.“제주관광정보 공식사이트”('www.visitjeju.net'이하 'visitjeju 홈페이지')라 함은 제주관광공사에서 운영하는 인터넷 홈페이지를 말합니다.</p>
										...
										<p>2. 사이트는 제1항과 같이 회원으로 가입할 것을 신청한 이용자 중 다음 각호에 해당하지 않는 한 회원으로 등록합니다. 1) 가입신청자가 이 약관 제8조 제3항에 의하여 이전에 회원자격을 상실한 적이 있는 경우, 다만 제8조 제3항에 의한 회원자격 상실 후 3년이 경과한 자로서 사이트의 회원재가입 승낙을 얻은 경우에는 예외로 한다.</p>
										...
										<p>4.회원은 제10조(개인정보보호) 제2항에 의한 가입사항을 변경 및 해지하고자 할 때에는 그 사항을 제주관광정보 공식사이트 회원정보변경 및 해지신청을 이용하여 변동하거나, 제주관광정보 공식사이트 운영자에게 메일을 이용하여 알려야 합니다.</p>
							...
							<li>
								...
								<div class="terms_box">
									...
									<p>3.전화 또는 메일 등을 이용 가입회원에 대한 실명확인을 할 수 있으며, 가입회원의 신상정보를 본인의 승낙없이 제3자에게 누설, 배포하지 않습니다.</p>
									<p>다만, 전기통신기본법 등 법률의 규정에 의해 국가기관의 요구가 있는 경우, 범죄에 대한 수사상의 목적이 있거나 정보통신윤리위원회의 요청이 있는 경우 또는 기타 관계법령에서 정한 절차에 따른 요청이 있는 경우에는 그러하지 않습니다.</p>
									<p>4.서비스 내용의 변경 또는 추가사항이 있을 경우에는 온라인으로 공지합니다.</p>
									<p>5.제주관광정보 공식사이트의 모든 정보가 제10조에 위배되는지의 점검을 위하여 필요한 경우에 일부 회원의 정보를 열람한 후 그 결과를 홈페이지에 게시할 수 있습니다.</p>
									<br>
									<p>제12조(이용자의 의무 등)</p>
									...
									<p>제주관광정보 공식사이트에 게재된 자료에 대한 권리는 다음 각호의 1과 같습니다.</p>
