					...
					<div class="join_terms_container">
						<ul>
							<li>
								...
								<div class="terms_box">
									<p>제1조(목적)</p>
										<p>이 약관은 한국인재개발원 이하 “2조”가 운영하는 제주관광정보 사이트('http://localhost:8090'이하 'Jeju_travel 홈페이지')에서 제공하는 인터넷 관련 서비스(이하 “서비스”라 한다)를 이용함에 있어 사이트와 이용자의 권리•의무 및 책임사항을 규정함을 목적으로 합니다.</p>
										<br>
										<p>제2조(약관의 범위 및 변경)</p>
										...
										<p>1. “제주관광정보 공식사이트”('http://localhost:8090'이하 'Jeju_travel 홈페이지')라 함은 제주관광공사에서 운영하는 인터넷 홈페이지를 말합니다.</p>
							...
							<li>
								...
								<div class="terms_box">
									...
									<p>1. 제주관광정보 사이트 시스템을 계속적 안정적으로 서비스를 제공할 의무가 있습니다.</p>
									<p>2. 제주관광정보 사이트 서비스를 위한 설비에 장애가 발생될 때에는 신속한 복구가 가능하도록 조치하여야 합니다.</p>
